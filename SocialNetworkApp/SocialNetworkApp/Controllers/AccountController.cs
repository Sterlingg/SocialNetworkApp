...
namespace SocialNetworkApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // GET: /Account/Login
        // Causes too many errors if changed to a Uri
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings", MessageId = "0#"), HttpGet]
        [AllowAnonymous]
        ...
        //
        // POST: /Account/Login
        //RedirectToLocal did not want a Uri but it did want a string.
        ...
        //Commented out due to errors and not being used
        ...
        //        {
        //            UserProfile user = db.UserProfiles.FirstOrDefault(u => u.UserName.ToLower(CultureInfo.CurrentCulture) == model.UserName.ToLower(CultureInfo.CurrentCulture));
        ...
        //    return View(model);
        //}
        // Commented out because we never use external logins
        ////
