...
namespace SocialNetworkApp.Models
{
    ...
    public class WebSecurityWrapper : IWebSecurity
    {
        ...
        public void AddUserToRole(string usern,string role){
              System.Web.Security.Roles.AddUserToRole(usern, role);
        }
        public void RemoveUserFromRole(string usern,string role){
             System.Web.Security.Roles.RemoveUserFromRole(usern, role);
        }                       
    }
}