...
/****
 *  IMPORTANT NOTE: WebSecurity.CurrentUserId replaced with method CurrentUserId()
 * 
 ****/ 
...
namespace SocialNetworkApp.Models
{
    ...
    public interface IWebSecurity
    {
        ...
        void AddUserToRole(string uName, string p);
        void RemoveUserFromRole(string uName, string p);
    }
}